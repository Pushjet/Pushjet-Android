...
import io.rubygrapefruit.platform.NativeIntegrationUnavailableException;
import io.rubygrapefruit.platform.PosixFiles;
...
public class FileSystemServices {
    ...
    public FileSystem createFileSystem(OperatingSystem operatingSystem) throws Exception {
        ...
        try {
            PosixFiles posixFiles = io.rubygrapefruit.platform.Native.get(PosixFiles.class);
